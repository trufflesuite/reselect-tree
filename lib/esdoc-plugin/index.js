const debug = require("debug")("reselect-tree:esdoc-plugin");
const assert = require('assert');
const path = require('path');
const fs = require('fs');
const DocFactory = require('./factory');
...
class Plugin {
  ...
  _setDefault() {
    ...
    if (!option.interfaces) option.interfaces = [
      'createSelectorTree', 'createLeaf',
      '<arrow>', '<function>', '<subtree>'
    ];
